<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true" CodeFile="UrunGuncelle.aspx.cs" Inherits="UrunGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="width:700px; height:auto; float:left;">
        <div style="width:680px;height:auto;margin:0 auto;">
            <asp:datalist runat="server" ID="dlUrunler" Width="680px" RepeatDirection="Horizontal" RepeatLayout="Flow">
                <ItemTemplate>
                    <div style="width: 200px; height: 220px; background-color: #f5f5f5; float:left; margin:12px;">
                        <div style="width:190px; margin:0 auto; height:150px;">
                            <a href="Guncelle.aspx?urunID=<%#Eval("urunID") %>"><asp:Image ID="Image1" runat="server" Height="150px" ImageUrl='<%# Eval("urunResim") %>' Width="190px" /></a>
                        </div>
